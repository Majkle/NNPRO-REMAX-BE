...
import fei.upce.nnprop.remax.model.meeting.MeetingRepository;
...
class MeetingServiceTest {
    ...
    @Mock
    private fei.upce.nnprop.remax.meetings.MeetingMapper meetingMapper;
    ...
    void createMeeting_Success() {
        ...
        when(realEstateRepository.findById(1L)).thenReturn(Optional.of(new fei.upce.nnprop.remax.model.realestates.entity.Apartment()));
    ...
    void createMeeting_RealtorMissing() {
        ...
        when(realEstateRepository.findById(any())).thenReturn(Optional.of(new fei.upce.nnprop.remax.model.realestates.entity.Apartment()));
